...
const ServicesSection = () => {
  useEffect(() => {
    const glidess = new Glide(".glide-ss", {
      type: "slider",
      focusAt: "center",
      perView: 1,
      autoplay: 3500,
              ...
              <div className="py-1 mt-lg-5">
                <div className="flex flex-wrap m-3 mt-40">
                  <div className="w-1/3 p-3">
                    <div
                      className="p-3 rounded-3xl border-0"
                      style={{ backgroundColor: "#E84C58" }}
                    >
                      <div className="flex mb-3 justify-center">
                        <div>
                          <img
                            src={`${process.env.PUBLIC_URL}/assets/images/c-2.png`}
                            alt=""
                            height="320"
                            width="320"
                            className="-mt-32 "
                      ...
                      <div className="w-full ">
                        ...
                        <p className="text-white text-center mt-3 mb-6 stolzl-200 leading-8 break-words flex ">
                          ...
                          elit. Nulla et earum ut, error maiores quo. Esse?
                          Lorem ipsum dolor sit, amet consectetur adipisicing
                          elit. Maxime,
                        </p>
                      </div>
                  ...
                  <div className="w-full md:w-1/3 p-3">
                    <div
                      className="p-3 rounded-3xl border-0"
                      style={{ backgroundColor: "#8F63F5" }}
                    >
                      <div className="flex mb-3 justify-center">
                        <div>
                          <img
                            src={`${process.env.PUBLIC_URL}/assets/images/warrior-kid.png`}
                            height="320"
                            width="320"
                            alt=""
                            className="-mt-32"
                  ...
                  <div className="w-full md:w-1/3 p-3">
                    <div
                      className="p-3 rounded-3xl border-0"
                      style={{ backgroundColor: "#35C6F3" }}
                    >
                      <div className="flex mb-3 justify-center">
                        <div>
                          <img
                            src={`${process.env.PUBLIC_URL}/assets/images/tree.png`}
                            alt=""
                            height="320"
                            width="320"
                            className="-mt-32"
