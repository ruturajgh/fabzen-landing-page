    ...
    <div className="relative glide-custom mt-16 max-w-6xl mx-auto ">
      ...
      <div className="overflow-hidden w-9xl " data-glide-el="track">
        <ul className="relative  p-0  flex  mt-28">
          <li className="w-2/4">
            <div className="bg-img container-lg mx-auto rounded-3xl p-5 w-full">
                      ...
                      <div className="mt-3" data-glide-el="controls">
                        ...
                        >
                          <span
                            ...
                            style={{
                              background:
                                "linear-gradient(to right, #C70062,#FF8A00)",
              ...
              <div className="flex flex-wrap">
                <div className=" md:w-1/2 p-4">
                  <div className="flex flex-col justify-between h-full">
                    ...
                    <div>
                      <h4 className="text-white stolzl-200 text-2xl mb-3">
                        Requirement Gathering
                      </h4>
